...
@Component({
  selector: 'app-get-physician',
  templateUrl: './get-physician.component.html',
  styleUrls: ['./get-physician.component.scss']
})
export class GetPhysicianComponent implements OnInit {
